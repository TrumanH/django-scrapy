...
class NewsSpider0(scrapy.Spider):
    name = 'news_spider'
    ...
    def parse(self, response):
        item = json.loads(response.text)['data'] #{'items':[CONTENT LIST...]}
        #print('测试', item['items'][0])
        #[{"id":155419,"public_date":1534719660,"observation_date":"2018-08-01",
        #"wscn_ticker":"UK161642","country":"英国","title":"8月Rightmove平...
        yield item #a dict contains a list which contains dicts
